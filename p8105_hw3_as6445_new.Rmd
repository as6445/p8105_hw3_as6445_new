...
The most commonly observed values is `r snow %>% count(snow, sort = TRUE) %>% slice(1:3) %>% pull(snow)` . This number would make sense because there should be more days that it does not snow in NY than days that snows. This falls in line with our general expectations of the weather in NY. 
