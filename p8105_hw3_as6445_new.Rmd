...
There are `r nrow(snow)` observations and `r ncol(snow)` columns in the snow data. The variables included are as following: `r colnames(snow)`.
...
There are `r nrow(avg_jan_july_p)` observations and `r ncol(avg_jan_july_p)` columns in the avg_jan_july_p dataset. The variables included are as following: `r colnames(avg_jan_july_p)`.
...
There are `r nrow(tmax_tmin_p)` observations and `r ncol(tmax_tmin_p)` columns in the tmax_tmin_p dataset. The variables included are as following: `r colnames(tmax_tmin_p)`.
...
There are `r nrow(snow_plot)` observations and `r ncol(snow_plot)` columns in the snow_plot dataset. The variables included are as following: `r colnames(snow_plot)`.
